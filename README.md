...
```
5.Now, if you open a browser and go to _http://localhost:8080_ you should see your function’s result.
...
You could also test your function by going to _http:localhost:8080/api/MY_FUNCTION?name=MY_NAME_ and you should see your Azure Function working just like it should.
